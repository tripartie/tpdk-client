...
*ResolutionCenterApi* | [**apiDisputesUlidparcelsGet**](docs/Api/ResolutionCenterApi.md#apidisputesulidparcelsget) | **GET** /disputes/{ulid}/parcels | Read single parcel state
