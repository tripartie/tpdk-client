...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://staging-api.tripartie.com';
    ...
    {
        $report  = 'PHP SDK (Tripartie\Tpdk) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.0.0-b2' . PHP_EOL;
