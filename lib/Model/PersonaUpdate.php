...
class PersonaUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'address' => '\Tripartie\Tpdk\Model\PersonaAddressUpdate',
        'externalPurchaseCount' => 'int',
        'externalSellCount' => 'int',
        'metadata' => '\Tripartie\Tpdk\Model\PersonaMetadataUpdate[]'
    ];
    ...
    */
     ...
     * Gets address
     *
     * @return \Tripartie\Tpdk\Model\PersonaAddressUpdate|null
     */
     ...
     * Sets address
     *
     * @param \Tripartie\Tpdk\Model\PersonaAddressUpdate|null $address address
     *
     * @return self
     */
    ...
    public function setExternalPurchaseCount($externalPurchaseCount)
    {
        ...
        if (($externalPurchaseCount < 0)) {
            throw new \InvalidArgumentException('invalid value for $externalPurchaseCount when calling PersonaUpdate., must be bigger than or equal to 0.');
        }
    ...
    public function setExternalSellCount($externalSellCount)
    {
        ...
        if (($externalSellCount < 0)) {
            throw new \InvalidArgumentException('invalid value for $externalSellCount when calling PersonaUpdate., must be bigger than or equal to 0.');
        }
     ...
     * Gets metadata
     *
     * @return \Tripartie\Tpdk\Model\PersonaMetadataUpdate[]|null
     */
     ...
     * Sets metadata
     *
     * @param \Tripartie\Tpdk\Model\PersonaMetadataUpdate[]|null $metadata You can assign different meta to your Persona object for different purposes. eg. Ease searching.
     *
     * @return self
     */
