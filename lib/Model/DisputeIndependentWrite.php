...
/**
 * DisputeIndependentWrite Class Doc Comment
 *
 * @category Class
 ...
 */
class DisputeIndependentWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dispute-IndependentWrite';
    ...
    protected static $openAPITypes = [
        'transaction' => '\Tripartie\Tpdk\Model\DisputeTransactionIndependentWrite',
        'redirectUrl' => 'string',
    ...
    */
     ...
     * Gets transaction
     *
     * @return \Tripartie\Tpdk\Model\DisputeTransactionIndependentWrite
     */
     ...
     * Sets transaction
     *
     * @param \Tripartie\Tpdk\Model\DisputeTransactionIndependentWrite $transaction transaction
     *
     * @return self
     */
    ...
    public function setMetadata($metadata)
    {
        ...
        if ((count($metadata) > 16)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling DisputeIndependentWrite., number of items must be less than or equal to 16.');
        }
