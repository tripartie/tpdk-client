...
/**
 * UserTotpToggleWrite Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class UserTotpToggleWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User-TotpToggleWrite';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['totpEnabled'] === null) {
            $invalidProperties[] = "'totpEnabled' can't be null";
        }
        if ($this->container['totpChallenge'] === null) {
            $invalidProperties[] = "'totpChallenge' can't be null";
        }
     ...
     * Sets totpEnabled
     *
     * @param bool $totpEnabled totpEnabled
     *
     * @return self
     */
     ...
     * Sets totpChallenge
     *
     * @param string $totpChallenge totpChallenge
     *
     * @return self
     */
