    ...
    */
    ...
    public function setRiskScore($riskScore)
    {
        ...
        if (!is_null($riskScore) && ($riskScore > 100)) {
            throw new \InvalidArgumentException('invalid value for $riskScore when calling PersonaRead., must be smaller than or equal to 100.');
        }
        if (!is_null($riskScore) && ($riskScore < 0)) {
            throw new \InvalidArgumentException('invalid value for $riskScore when calling PersonaRead., must be bigger than or equal to 0.');
        }
     ...
     * Gets metadata
     *
     * @return \Tripartie\Tpdk\Model\PersonaMetadataRead[]|null
     */
     ...
     * Sets metadata
     *
     * @param \Tripartie\Tpdk\Model\PersonaMetadataRead[]|null $metadata You can assign different meta to your Persona object for different purposes. eg. Ease searching.
     *
     * @return self
     */
