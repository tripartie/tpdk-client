...
/**
 * DisputeOfferRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class DisputeOfferRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dispute-Offer-Read';
    ...
    protected static $openAPITypes = [
        'ulid' => 'string',
        'publicUrl' => 'string',
        'organization' => '\Tripartie\Tpdk\Model\DisputeOrganizationRead',
        'seller' => '\Tripartie\Tpdk\Model\DisputePersonaRead',
        'nature' => 'string',
        'title' => 'string',
        'description' => 'string',
        'unitPrice' => 'float',
        ...
        'itemCount' => 'int',
        'condition' => 'string',
        'medias' => '\Tripartie\Tpdk\Model\DisputeMediaRead[]'
    ];
    ...
    */
     ...
     * Gets organization
     *
     * @return \Tripartie\Tpdk\Model\DisputeOrganizationRead|null
     */
     ...
     * Sets organization
     *
     * @param \Tripartie\Tpdk\Model\DisputeOrganizationRead|null $organization organization
     *
     * @return self
     */
     ...
     * Sets seller
     *
     * @param \Tripartie\Tpdk\Model\DisputePersonaRead $seller If the seller is actually YOUR organization, set it to NULL.
     *
     * @return self
     */
     ...
     * Gets medias
     *
     * @return \Tripartie\Tpdk\Model\DisputeMediaRead[]
     */
     ...
     * Sets medias
     *
     * @param \Tripartie\Tpdk\Model\DisputeMediaRead[] $medias medias
     *
     * @return self
     */
