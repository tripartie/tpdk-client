...
/**
 * PersonaAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class PersonaAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Persona_address';
    ...
    */
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if (!is_null($countryCode) && (mb_strlen($countryCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling PersonaAddress., must be smaller than or equal to 3.');
        }
