...
/**
 * NotificationRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class NotificationRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Notification-Read';
    ...
    public const TYPE_DISPUTE_STATE_UPDATE = 'DISPUTE_STATE_UPDATE';
    public const TYPE_DISPUTE_REMINDER = 'DISPUTE_REMINDER';
    public const TYPE_MESSAGE_SENT = 'MESSAGE_SENT';
    public const TYPE_DISPUTE_SETTLEMENT = 'DISPUTE_SETTLEMENT';
    public const TYPE_DISPUTE_ARBITRATION_REQUIRED = 'DISPUTE_ARBITRATION_REQUIRED';
    ...
    {
        return [
            self::TYPE_DISPUTE_STATE_UPDATE,
            self::TYPE_DISPUTE_REMINDER,
            self::TYPE_MESSAGE_SENT,
            self::TYPE_DISPUTE_SETTLEMENT,
            self::TYPE_DISPUTE_ARBITRATION_REQUIRED,
