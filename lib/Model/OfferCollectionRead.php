...
class OfferCollectionRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'ulid' => 'string',
        'publicUrl' => 'string',
        'seller' => '\Tripartie\Tpdk\Model\PersonaCollectionRead',
        'title' => 'string',
        'unitPrice' => 'float',
        'currencyCode' => 'string',
        'itemCount' => 'int',
    ...
    */
     ...
     * Sets seller
     *
     * @param \Tripartie\Tpdk\Model\PersonaCollectionRead $seller If the seller is actually YOUR organization, set it to NULL.
     *
     * @return self
     */
