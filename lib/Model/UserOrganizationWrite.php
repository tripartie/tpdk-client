...
/**
 * UserOrganizationWrite Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class UserOrganizationWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User-Organization-Write';
    ...
    protected static $openAPITypes = [
        ...
        'websiteUrl' => 'string',
        'billingAddress' => '\Tripartie\Tpdk\Model\UserAddressWrite'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UserOrganizationWrite., must be smaller than or equal to 64.');
        }
    ...
    public function setVatNumber($vatNumber)
    {
        ...
        if (!is_null($vatNumber) && (mb_strlen($vatNumber) > 32)) {
            throw new \InvalidArgumentException('invalid length for $vatNumber when calling UserOrganizationWrite., must be smaller than or equal to 32.');
        }
    ...
    public function setCommercialRegistryNumber($commercialRegistryNumber)
    {
        ...
        if ((mb_strlen($commercialRegistryNumber) > 32)) {
            throw new \InvalidArgumentException('invalid length for $commercialRegistryNumber when calling UserOrganizationWrite., must be smaller than or equal to 32.');
        }
    ...
    public function setWebsiteUrl($websiteUrl)
    {
        ...
        if (!is_null($websiteUrl) && (mb_strlen($websiteUrl) > 64)) {
            throw new \InvalidArgumentException('invalid length for $websiteUrl when calling UserOrganizationWrite., must be smaller than or equal to 64.');
        }
     ...
     * Gets billingAddress
     *
     * @return \Tripartie\Tpdk\Model\UserAddressWrite|null
     */
     ...
     * Sets billingAddress
     *
     * @param \Tripartie\Tpdk\Model\UserAddressWrite|null $billingAddress billingAddress
     *
     * @return self
     */
