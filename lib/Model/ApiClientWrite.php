...
class ApiClientWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const DESIRED_SCOPES_DISPUTE_READ = 'DISPUTE_READ';
    public const DESIRED_SCOPES_DISPUTE_WRITE = 'DISPUTE_WRITE';
    ...
    public function getDesiredScopesAllowableValues()
    {
        return [
            ...
            self::DESIRED_SCOPES_DISPUTE_READ,
            self::DESIRED_SCOPES_DISPUTE_WRITE,
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['referenceName'] === null) {
            $invalidProperties[] = "'referenceName' can't be null";
        }
        if ((mb_strlen($this->container['referenceName']) > 32)) {
