...
class DisputeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['issueDetails']) && (mb_strlen($this->container['issueDetails']) > 1000)) {
            $invalidProperties[] = "invalid value for 'issueDetails', the character length must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['issueDetails']) && (mb_strlen($this->container['issueDetails']) < 30)) {
        ...
        if (!is_null($this->container['sellerNotes']) && (mb_strlen($this->container['sellerNotes']) > 1000)) {
            $invalidProperties[] = "invalid value for 'sellerNotes', the character length must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['sellerNotes']) && (mb_strlen($this->container['sellerNotes']) < 30)) {
            $invalidProperties[] = "invalid value for 'sellerNotes', the character length must be bigger than or equal to 30.";
        }
        ...
        if (!is_null($this->container['platformReasoning']) && (mb_strlen($this->container['platformReasoning']) > 1000)) {
            $invalidProperties[] = "invalid value for 'platformReasoning', the character length must be smaller than or equal to 1000.";
        }

        if (!is_null($this->container['platformReasoning']) && (mb_strlen($this->container['platformReasoning']) < 30)) {
            $invalidProperties[] = "invalid value for 'platformReasoning', the character length must be bigger than or equal to 30.";
        }
    ...
    public function setSellerNotes($sellerNotes)
    {
        ...
        if (!is_null($sellerNotes) && (mb_strlen($sellerNotes) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $sellerNotes when calling DisputeUpdate., must be smaller than or equal to 1000.');
        }
        if (!is_null($sellerNotes) && (mb_strlen($sellerNotes) < 30)) {
            throw new \InvalidArgumentException('invalid length for $sellerNotes when calling DisputeUpdate., must be bigger than or equal to 30.');
        }
    ...
    public function setPlatformReasoning($platformReasoning)
    {
        ...
        if (!is_null($platformReasoning) && (mb_strlen($platformReasoning) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $platformReasoning when calling DisputeUpdate., must be smaller than or equal to 1000.');
        }
        if (!is_null($platformReasoning) && (mb_strlen($platformReasoning) < 30)) {
            throw new \InvalidArgumentException('invalid length for $platformReasoning when calling DisputeUpdate., must be bigger than or equal to 30.');
        }
