...
/**
 * UserAuthenticatedRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class UserAuthenticatedRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User-AuthenticatedRead';
    ...
    protected static $openAPITypes = [
        ...
        'avatar' => '\Tripartie\Tpdk\Model\OrganizationAuthenticatedReadIcon',
        'createdAt' => '\DateTime',
        'updatedAt' => '\DateTime',
        'consentMailNotification' => 'bool',
        'consentMailAds' => 'bool',
        'organization' => '\Tripartie\Tpdk\Model\UserAuthenticatedReadOrganization'
    ];
    ...
    */
    ...
    public function setOriginCountry($originCountry)
    {
        ...
        if ((mb_strlen($originCountry) > 3)) {
            throw new \InvalidArgumentException('invalid length for $originCountry when calling UserAuthenticatedRead., must be smaller than or equal to 3.');
        }
    ...
    public function setPreferredLanguage($preferredLanguage)
    {
        ...
        if ((mb_strlen($preferredLanguage) > 2)) {
            throw new \InvalidArgumentException('invalid length for $preferredLanguage when calling UserAuthenticatedRead., must be smaller than or equal to 2.');
        }
     ...
     * Sets avatar
     *
     * @param \Tripartie\Tpdk\Model\OrganizationAuthenticatedReadIcon|null $avatar avatar
     *
     * @return self
     */
     ...
     * Gets organization
     *
     * @return \Tripartie\Tpdk\Model\UserAuthenticatedReadOrganization|null
     */
     ...
     * Sets organization
     *
     * @param \Tripartie\Tpdk\Model\UserAuthenticatedReadOrganization|null $organization organization
     *
     * @return self
     */
