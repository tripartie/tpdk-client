...
/**
 * DisputeOfferIndependentWrite Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class DisputeOfferIndependentWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dispute-Offer-IndependentWrite';
    ...
    protected static $openAPITypes = [
        'publicUrl' => 'string',
        'seller' => '\Tripartie\Tpdk\Model\DisputePersonaIndependentWrite',
        'nature' => 'string',
        'title' => 'string',
        'description' => 'string',
        'unitPrice' => 'float',
    ...
    */
     ...
     * Sets seller
     *
     * @param \Tripartie\Tpdk\Model\DisputePersonaIndependentWrite $seller If the seller is actually YOUR organization, set it to NULL.
     *
     * @return self
     */
