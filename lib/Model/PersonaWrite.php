...
/**
 * PersonaWrite Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class PersonaWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Persona-Write';
    ...
    protected static $openAPITypes = [
        ...
        'address' => '\Tripartie\Tpdk\Model\PersonaAddressWrite',
        'externalPurchaseCount' => 'int',
        'externalSellCount' => 'int',
        'metadata' => '\Tripartie\Tpdk\Model\PersonaMetadataWrite[]'
    ];
    ...
    */
    ...
    public function setFirstName($firstName)
    {
        ...
        if ((mb_strlen($firstName) > 64)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling PersonaWrite., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($firstName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling PersonaWrite., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($lastName)
    {
        ...
        if ((mb_strlen($lastName) > 64)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling PersonaWrite., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($lastName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling PersonaWrite., must be bigger than or equal to 1.');
        }
     ...
     * Gets address
     *
     * @return \Tripartie\Tpdk\Model\PersonaAddressWrite|null
     */
     ...
     * Sets address
     *
     * @param \Tripartie\Tpdk\Model\PersonaAddressWrite|null $address address
     *
     * @return self
     */
    ...
    public function setExternalPurchaseCount($externalPurchaseCount)
    {
        ...
        if (($externalPurchaseCount < 0)) {
            throw new \InvalidArgumentException('invalid value for $externalPurchaseCount when calling PersonaWrite., must be bigger than or equal to 0.');
        }
    ...
    public function setExternalSellCount($externalSellCount)
    {
        ...
        if (($externalSellCount < 0)) {
            throw new \InvalidArgumentException('invalid value for $externalSellCount when calling PersonaWrite., must be bigger than or equal to 0.');
        }
     ...
     * Gets metadata
     *
     * @return \Tripartie\Tpdk\Model\PersonaMetadataWrite[]|null
     */
     ...
     * Sets metadata
     *
     * @param \Tripartie\Tpdk\Model\PersonaMetadataWrite[]|null $metadata You can assign different meta to your Persona object for different purposes. eg. Ease searching.
     *
     * @return self
     */
    public function setMetadata($metadata)
    {
        ...
        if ((count($metadata) > 16)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling PersonaWrite., number of items must be less than or equal to 16.');
        }
