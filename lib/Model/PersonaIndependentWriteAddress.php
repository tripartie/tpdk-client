...
/**
 * PersonaIndependentWriteAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class PersonaIndependentWriteAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Persona_IndependentWrite_address';
    ...
    */
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling PersonaIndependentWriteAddress., must be smaller than or equal to 3.');
        }
