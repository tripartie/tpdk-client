...
/**
 * PersonaReadAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class PersonaReadAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Persona_Read_address';
    ...
    */
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling PersonaReadAddress., must be smaller than or equal to 3.');
        }
