...
/**
 * PersonaUpdateAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class PersonaUpdateAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Persona_Update_address';
    ...
    */
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling PersonaUpdateAddress., must be smaller than or equal to 3.');
        }
