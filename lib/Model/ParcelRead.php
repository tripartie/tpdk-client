 ...
 */
class ParcelRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Parcel-Read';
    ...
    */
    ...
    public function setIdentifier($identifier)
    {
        ...
        if ((mb_strlen($identifier) > 128)) {
            throw new \InvalidArgumentException('invalid length for $identifier when calling ParcelRead., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($identifier) < 4)) {
            throw new \InvalidArgumentException('invalid length for $identifier when calling ParcelRead., must be bigger than or equal to 4.');
        }
    ...
    public function setPrice($price)
    {
        ...
        if (!is_null($price) && ($price < 0)) {
            throw new \InvalidArgumentException('invalid value for $price when calling ParcelRead., must be bigger than or equal to 0.');
        }
