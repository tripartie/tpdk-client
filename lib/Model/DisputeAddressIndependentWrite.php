...
/**
 * DisputeAddressIndependentWrite Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class DisputeAddressIndependentWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dispute-Address-IndependentWrite';
    ...
    */
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling DisputeAddressIndependentWrite., must be smaller than or equal to 3.');
        }
