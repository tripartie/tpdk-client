    ...
    */
    ...
    public function setCallbackUrl($callbackUrl)
    {
        ...
        if ((mb_strlen($callbackUrl) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $callbackUrl when calling WebhookSubscriptionRead., must be smaller than or equal to 5000.');
        }
        if ((mb_strlen($callbackUrl) < 4)) {
            throw new \InvalidArgumentException('invalid length for $callbackUrl when calling WebhookSubscriptionRead., must be bigger than or equal to 4.');
        }
