...
/**
 * EvaluationRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class EvaluationRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Evaluation-Read';
    ...
    */
    ...
    public function setRating($rating)
    {
        ...
        if (($rating > 10)) {
            throw new \InvalidArgumentException('invalid value for $rating when calling EvaluationRead., must be smaller than or equal to 10.');
        }
        if (($rating < 0)) {
            throw new \InvalidArgumentException('invalid value for $rating when calling EvaluationRead., must be bigger than or equal to 0.');
        }
    ...
    public function setComment($comment)
    {
        ...
        if (!is_null($comment) && (mb_strlen($comment) > 500)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling EvaluationRead., must be smaller than or equal to 500.');
        }
