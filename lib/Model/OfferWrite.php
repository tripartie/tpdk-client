 ...
 */
class OfferWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Offer-Write';
    ...
    protected static $openAPITypes = [
        ...
        'metadata' => '\Tripartie\Tpdk\Model\MetadataWrite[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['unitPrice']) && ($this->container['unitPrice'] <= 0)) {
            $invalidProperties[] = "invalid value for 'unitPrice', must be bigger than 0.";
        }
        ...
        if (!is_null($this->container['weightInGram']) && ($this->container['weightInGram'] <= 0)) {
            $invalidProperties[] = "invalid value for 'weightInGram', must be bigger than 0.";
        }
     ...
     *
     * @param bool|null $enforcePersonaAuth Mean that the generated url cannot be accessed without a generated token for a Persona. Disallow external registration.
     *
     * @return self
     */
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) > 250)) {
            throw new \InvalidArgumentException('invalid length for $title when calling OfferWrite., must be smaller than or equal to 250.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 100000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling OfferWrite., must be smaller than or equal to 100000.');
        }
    ...
    public function setUnitPrice($unitPrice)
    {
        ...
        if (!is_null($unitPrice) && ($unitPrice <= 0)) {
            throw new \InvalidArgumentException('invalid value for $unitPrice when calling OfferWrite., must be bigger than 0.');
        }
    ...
    public function setItemCount($itemCount)
    {
        ...
        if (($itemCount <= 0)) {
            throw new \InvalidArgumentException('invalid value for $itemCount when calling OfferWrite., must be bigger than 0.');
        }
    ...
    public function setWeightInGram($weightInGram)
    {
        ...
        if (!is_null($weightInGram) && ($weightInGram <= 0)) {
            throw new \InvalidArgumentException('invalid value for $weightInGram when calling OfferWrite., must be bigger than 0.');
        }
     ...
     *
     * @param bool|null $canBeSoldSeparately Set this flag to false to forbid a potential buyer to acquire this item separately.          This is only useful in a BulkOffer context.
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \Tripartie\Tpdk\Model\MetadataWrite[]|null
     */
     ...
     * Sets metadata
     *
     * @param \Tripartie\Tpdk\Model\MetadataWrite[]|null $metadata metadata
     *
     * @return self
     */
