...
/**
 * EvaluationWrite Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class EvaluationWrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Evaluation-Write';
    ...
    */
    ...
    public function setRating($rating)
    {
        ...
        if (($rating > 10)) {
            throw new \InvalidArgumentException('invalid value for $rating when calling EvaluationWrite., must be smaller than or equal to 10.');
        }
        if (($rating < 0)) {
            throw new \InvalidArgumentException('invalid value for $rating when calling EvaluationWrite., must be bigger than or equal to 0.');
        }
    ...
    public function setComment($comment)
    {
        ...
        if (!is_null($comment) && (mb_strlen($comment) > 500)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling EvaluationWrite., must be smaller than or equal to 500.');
        }
