    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UserWriteOrganization., must be smaller than or equal to 64.');
        }
     ...
     * Sets vatNumber
     *
     * @param mixed $vatNumber vatNumber
     *
     * @return self
     */
    public function setVatNumber($vatNumber)
    {
        ...
        if (!is_null($vatNumber) && (mb_strlen($vatNumber) > 32)) {
            throw new \InvalidArgumentException('invalid length for $vatNumber when calling UserWriteOrganization., must be smaller than or equal to 32.');
        }
     ...
     *
     * @param mixed $commercialRegistryNumber commercialRegistryNumber
     *
     * @return self
     */
    public function setCommercialRegistryNumber($commercialRegistryNumber)
    {
        if (is_null($commercialRegistryNumber)) {
            array_push($this->openAPINullablesSetToNull, 'commercialRegistryNumber');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('commercialRegistryNumber', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($commercialRegistryNumber) && (mb_strlen($commercialRegistryNumber) > 32)) {
            throw new \InvalidArgumentException('invalid length for $commercialRegistryNumber when calling UserWriteOrganization., must be smaller than or equal to 32.');
        }
    ...
    public function setWebsiteUrl($websiteUrl)
    {
        ...
        if (!is_null($websiteUrl) && (mb_strlen($websiteUrl) > 64)) {
            throw new \InvalidArgumentException('invalid length for $websiteUrl when calling UserWriteOrganization., must be smaller than or equal to 64.');
        }
