...
/**
 * DisputeOfferCollectionRead Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class DisputeOfferCollectionRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Dispute-Offer-CollectionRead';
    ...
    protected static $openAPITypes = [
        'ulid' => 'string',
        'publicUrl' => 'string',
        'seller' => '\Tripartie\Tpdk\Model\DisputePersonaCollectionRead',
        'title' => 'string',
        'unitPrice' => 'float',
        'currencyCode' => 'string',
        'itemCount' => 'int',
    ...
    */
     ...
     * Sets seller
     *
     * @param \Tripartie\Tpdk\Model\DisputePersonaCollectionRead $seller If the seller is actually YOUR organization, set it to NULL.
     *
     * @return self
     */
