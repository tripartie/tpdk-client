...
/**
 * UserUserEmailUpdate Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class UserUserEmailUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User-UserEmailUpdate';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 180)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserUserEmailUpdate., must be smaller than or equal to 180.');
        }
    ...
    public function setPlainPassword($plainPassword)
    {
        ...
        if (!is_null($plainPassword) && (mb_strlen($plainPassword) > 64)) {
            throw new \InvalidArgumentException('invalid length for $plainPassword when calling UserUserEmailUpdate., must be smaller than or equal to 64.');
        }
        if (!is_null($plainPassword) && (mb_strlen($plainPassword) < 6)) {
            throw new \InvalidArgumentException('invalid length for $plainPassword when calling UserUserEmailUpdate., must be bigger than or equal to 6.');
        }
