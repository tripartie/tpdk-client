...
/**
 * UserUserPasswordUpdate Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  Tripartie\Tpdk
 ...
 */
class UserUserPasswordUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User-UserPasswordUpdate';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['newPassword']) < 6)) {
            $invalidProperties[] = "invalid value for 'newPassword', the character length must be bigger than or equal to 6.";
        }
    ...
    public function setPlainPassword($plainPassword)
    {
        ...
        if (!is_null($plainPassword) && (mb_strlen($plainPassword) > 64)) {
            throw new \InvalidArgumentException('invalid length for $plainPassword when calling UserUserPasswordUpdate., must be smaller than or equal to 64.');
        }
        if (!is_null($plainPassword) && (mb_strlen($plainPassword) < 6)) {
            throw new \InvalidArgumentException('invalid length for $plainPassword when calling UserUserPasswordUpdate., must be bigger than or equal to 6.');
        }
    ...
    public function setNewPassword($newPassword)
    {
        ...
        if (!is_null($newPassword) && (mb_strlen($newPassword) > 64)) {
            throw new \InvalidArgumentException('invalid length for $newPassword when calling UserUserPasswordUpdate., must be smaller than or equal to 64.');
        }
        if (!is_null($newPassword) && (mb_strlen($newPassword) < 6)) {
            throw new \InvalidArgumentException('invalid length for $newPassword when calling UserUserPasswordUpdate., must be bigger than or equal to 6.');
        }
