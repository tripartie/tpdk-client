 ...
 */
class UserApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User_api';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('monthlyQuota', $data ?? [], null);
    ...
    */
    ...
    public function setIdentifier($identifier)
    {
        ...
        if ((mb_strlen($identifier) > 32)) {
            throw new \InvalidArgumentException('invalid length for $identifier when calling UserApi., must be smaller than or equal to 32.');
        }
    ...
    {
        return $this->container['monthlyQuota'];
    }

    /**
     * Sets monthlyQuota
     *
     * @param int|null $monthlyQuota monthlyQuota
     *
     * @return self
     */
    public function setMonthlyQuota($monthlyQuota)
    {
        if (is_null($monthlyQuota)) {
            array_push($this->openAPINullablesSetToNull, 'monthlyQuota');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('monthlyQuota', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['monthlyQuota'] = $monthlyQuota;
