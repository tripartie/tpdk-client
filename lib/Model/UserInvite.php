 ...
 */
class UserInvite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User-Invite';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['invitedRole'] === null) {
            $invalidProperties[] = "'invitedRole' can't be null";
        }
    ...
    public function setFirstName($firstName)
    {
        ...
        if ((mb_strlen($firstName) > 64)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling UserInvite., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($firstName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling UserInvite., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($lastName)
    {
        ...
        if ((mb_strlen($lastName) > 64)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling UserInvite., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($lastName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling UserInvite., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 180)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserInvite., must be smaller than or equal to 180.');
        }
     ...
     * Sets invitedRole
     *
     * @param string[] $invitedRole invitedRole
     *
     * @return self
     */
    public function setInvitedRole($invitedRole)
    {
        if (is_null($invitedRole)) {
            array_push($this->openAPINullablesSetToNull, 'invitedRole');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('invitedRole', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        if (!is_null($invitedRole) && array_diff($invitedRole, $allowedValues)) {
