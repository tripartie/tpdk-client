...
/**
     ...
     *
     * @param  \Tripartie\Tpdk\Model\PersonaPersonaExternalAuth $personaPersonaExternalAuth The new Persona resource (required)
     ...
     * @return \Tripartie\Tpdk\Model\PersonaPersonaAuthReturn
     */
    public function apiPersonasauthenticationPost($personaPersonaExternalAuth, string $contentType = self::contentTypes['apiPersonasauthenticationPost'][0])
    {
        list($response) = $this->apiPersonasauthenticationPostWithHttpInfo($personaPersonaExternalAuth, $contentType);
        return $response;
    }
     ...
     * @throws \Tripartie\Tpdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripartie\Tpdk\Model\PersonaPersonaAuthReturn, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiPersonasauthenticationPostWithHttpInfo($personaPersonaExternalAuth, string $contentType = self::contentTypes['apiPersonasauthenticationPost'][0])
    {
        $request = $this->apiPersonasauthenticationPostRequest($personaPersonaExternalAuth, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Tripartie\Tpdk\Model\PersonaPersonaAuthReturn' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Tripartie\Tpdk\Model\PersonaPersonaAuthReturn' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Tripartie\Tpdk\Model\PersonaPersonaAuthReturn', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Tripartie\Tpdk\Model\PersonaPersonaAuthReturn';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripartie\Tpdk\Model\PersonaPersonaAuthReturn',
     ...
     */
    public function apiPersonasauthenticationPostAsync($personaPersonaExternalAuth, string $contentType = self::contentTypes['apiPersonasauthenticationPost'][0])
    {
        return $this->apiPersonasauthenticationPostAsyncWithHttpInfo($personaPersonaExternalAuth, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPersonasauthenticationPostAsyncWithHttpInfo($personaPersonaExternalAuth, string $contentType = self::contentTypes['apiPersonasauthenticationPost'][0])
    {
        $returnType = '\Tripartie\Tpdk\Model\PersonaPersonaAuthReturn';
        $request = $this->apiPersonasauthenticationPostRequest($personaPersonaExternalAuth, $contentType);
     ...
     */
    public function apiPersonasauthenticationPostRequest($personaPersonaExternalAuth, string $contentType = self::contentTypes['apiPersonasauthenticationPost'][0])
    {

        // verify the required parameter 'personaPersonaExternalAuth' is set
        if ($personaPersonaExternalAuth === null || (is_array($personaPersonaExternalAuth) && count($personaPersonaExternalAuth) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $personaPersonaExternalAuth when calling apiPersonasauthenticationPost'
            );
        }
        ...
        // for model (json/xml)
        if (isset($personaPersonaExternalAuth)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($personaPersonaExternalAuth));
            } else {
                $httpBody = $personaPersonaExternalAuth;
            }
