...
/**
     ...
     * @return \Tripartie\Tpdk\Model\Notification[]
     */
     ...
     * @throws \Tripartie\Tpdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tripartie\Tpdk\Model\Notification[], HTTP status code, HTTP response headers (array of strings)
     */
    public function apiPersonasIdnotificationsGetCollectionWithHttpInfo($id, $page = 1, string $contentType = self::contentTypes['apiPersonasIdnotificationsGetCollection'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Tripartie\Tpdk\Model\Notification[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Tripartie\Tpdk\Model\Notification[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Tripartie\Tpdk\Model\Notification[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Tripartie\Tpdk\Model\Notification[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tripartie\Tpdk\Model\Notification[]',
     ...
     * @param  \Tripartie\Tpdk\Model\Notification $notification The updated Notification resource (required)
     ...
     * @return \Tripartie\Tpdk\Model\Notification
     */
    public function apiPersonasPersonaIdnotificationsIdPatch($personaId, $id, $notification, string $contentType = self::contentTypes['apiPersonasPersonaIdnotificationsIdPatch'][0])
    {
        list($response) = $this->apiPersonasPersonaIdnotificationsIdPatchWithHttpInfo($personaId, $id, $notification, $contentType);
        return $response;
    }
     ...
     * @return array of \Tripartie\Tpdk\Model\Notification, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiPersonasPersonaIdnotificationsIdPatchWithHttpInfo($personaId, $id, $notification, string $contentType = self::contentTypes['apiPersonasPersonaIdnotificationsIdPatch'][0])
    {
        $request = $this->apiPersonasPersonaIdnotificationsIdPatchRequest($personaId, $id, $notification, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPersonasPersonaIdnotificationsIdPatchAsync($personaId, $id, $notification, string $contentType = self::contentTypes['apiPersonasPersonaIdnotificationsIdPatch'][0])
    {
        return $this->apiPersonasPersonaIdnotificationsIdPatchAsyncWithHttpInfo($personaId, $id, $notification, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiPersonasPersonaIdnotificationsIdPatchAsyncWithHttpInfo($personaId, $id, $notification, string $contentType = self::contentTypes['apiPersonasPersonaIdnotificationsIdPatch'][0])
    {
        $returnType = '\Tripartie\Tpdk\Model\Notification';
        $request = $this->apiPersonasPersonaIdnotificationsIdPatchRequest($personaId, $id, $notification, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiPersonasPersonaIdnotificationsIdPatchRequest($personaId, $id, $notification, string $contentType = self::contentTypes['apiPersonasPersonaIdnotificationsIdPatch'][0])
    {
        ...
        if ($notification === null || (is_array($notification) && count($notification) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $notification when calling apiPersonasPersonaIdnotificationsIdPatch'
            );
        }
        ...
        if (isset($notification)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($notification));
            } else {
