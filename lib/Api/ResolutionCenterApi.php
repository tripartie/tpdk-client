...
/**
     ...
     */
    public function apiDisputesUlidevidencesGetCollection($ulid, $page = 1, string $contentType = self::contentTypes['apiDisputesUlidevidencesGetCollection'][0])
    {
        list($response) = $this->apiDisputesUlidevidencesGetCollectionWithHttpInfo($ulid, $page, $contentType);
        return $response;
    }
     ...
     */
    public function apiDisputesUlidevidencesGetCollectionWithHttpInfo($ulid, $page = 1, string $contentType = self::contentTypes['apiDisputesUlidevidencesGetCollection'][0])
    {
        $request = $this->apiDisputesUlidevidencesGetCollectionRequest($ulid, $page, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiDisputesUlidevidencesGetCollectionAsync($ulid, $page = 1, string $contentType = self::contentTypes['apiDisputesUlidevidencesGetCollection'][0])
    {
        return $this->apiDisputesUlidevidencesGetCollectionAsyncWithHttpInfo($ulid, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiDisputesUlidevidencesGetCollectionAsyncWithHttpInfo($ulid, $page = 1, string $contentType = self::contentTypes['apiDisputesUlidevidencesGetCollection'][0])
    {
        $returnType = '\Tripartie\Tpdk\Model\EvidenceRead[]';
        $request = $this->apiDisputesUlidevidencesGetCollectionRequest($ulid, $page, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiDisputesUlidevidencesGetCollectionRequest($ulid, $page = 1, string $contentType = self::contentTypes['apiDisputesUlidevidencesGetCollection'][0])
    {
    ...
    /**
     * Operation apiDisputesUlidparcelsGet
     *
     * Read single parcel state
     *
     * @param  string $ulid Dispute identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiDisputesUlidparcelsGet'] to see the possible values for this operation
     *
     * @throws \Tripartie\Tpdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Tripartie\Tpdk\Model\ParcelRead
     */
    public function apiDisputesUlidparcelsGet($ulid, string $contentType = self::contentTypes['apiDisputesUlidparcelsGet'][0])
    {
        list($response) = $this->apiDisputesUlidparcelsGetWithHttpInfo($ulid, $contentType);
        return $response;
    }

    /**
     * Operation apiDisputesUlidparcelsGetWithHttpInfo
     *
     * Read single parcel state
     *
     * @param  string $ulid Dispute identifier (required)
     ...
     */
    public function apiDisputesUlidparcelsGetWithHttpInfo($ulid, string $contentType = self::contentTypes['apiDisputesUlidparcelsGet'][0])
    {
        $request = $this->apiDisputesUlidparcelsGetRequest($ulid, $contentType);
    ...
    /**
     * Operation apiDisputesUlidparcelsGetAsync
     *
     * Read single parcel state
     *
     * @param  string $ulid Dispute identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiDisputesUlidparcelsGetAsync($ulid, string $contentType = self::contentTypes['apiDisputesUlidparcelsGet'][0])
    {
        return $this->apiDisputesUlidparcelsGetAsyncWithHttpInfo($ulid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiDisputesUlidparcelsGetAsyncWithHttpInfo
     *
     * Read single parcel state
     *
     * @param  string $ulid Dispute identifier (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiDisputesUlidparcelsGetAsyncWithHttpInfo($ulid, string $contentType = self::contentTypes['apiDisputesUlidparcelsGet'][0])
    {
        $returnType = '\Tripartie\Tpdk\Model\ParcelRead';
        $request = $this->apiDisputesUlidparcelsGetRequest($ulid, $contentType);
    ...
    /**
     * Create request for operation 'apiDisputesUlidparcelsGet'
     *
     * @param  string $ulid Dispute identifier (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['apiDisputesUlidparcelsGet'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiDisputesUlidparcelsGetRequest($ulid, string $contentType = self::contentTypes['apiDisputesUlidparcelsGet'][0])
    {

        // verify the required parameter 'ulid' is set
        if ($ulid === null || (is_array($ulid) && count($ulid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ulid when calling apiDisputesUlidparcelsGet'
            );
        }
